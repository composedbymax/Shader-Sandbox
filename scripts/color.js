class ColorPicker {
    ...
    Styles() {
        ...
        style.textContent = `
            ...
            .glsl-color-picker{position: absolute;background: var(--2);border-radius: 8px;padding: 20px;box-shadow: 0 4px 20px rgba(0, 0, 0, 0.5);color: var(--7);font-family: 'Consolas', 'Monaco', monospace;min-width: 300px;max-width: 350px;pointer-events: auto;border: 1px solid var(--4);}
            ...
            .glsl-color-highlight{background-color: rgba(0, 132, 255, 0.3) !important;border-radius: 2px;}
            .glsl-tab{position: absolute;width: 24px;height: 24px;background: var(--1);border: 1px solid var(--4);border-radius: 4px;display: flex;justify-content: center;align-items: center;cursor: pointer;z-index: 10001;box-shadow: 0 2px 6px rgba(0,0,0,0.4);transition: opacity 0.2s ease;}
