!function() {
    ...
    function r() {
        ...
        ["scripts/save.js", "scripts/performance.js", "scripts/script.js", "scripts/recorder.js", "scripts/parse.js", "scripts/stay.js", "scripts/right.js"].reduce(( (n, r) => n.then(( () => e ? Promise.reject(new Error("Aborted: debugging detected")) : new Promise(( (e, n) => {
